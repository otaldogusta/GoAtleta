-- Keep the document intelligence API surface intentionally narrow.
-- Supabase default table/function grants can be broader than the policies
-- declared by the feature migration, so revoke before granting the minimum.
