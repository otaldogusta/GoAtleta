...
export const getNotificationsModule = (): typeof import("expo-notifications") | null => {
  ...
  try {
    // eslint-disable-next-line @typescript-eslint/no-require-imports -- Synchronous capability probe; unsupported Expo Go and web return before native initialization.
