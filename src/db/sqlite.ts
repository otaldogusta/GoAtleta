...
if (Platform.OS === "web") {
  ...
  // eslint-disable-next-line @typescript-eslint/no-require-imports -- Synchronous native bootstrap; web must never initialize expo-sqlite.
...
export function initDb() {
  db.execSync(
    ...
    CREATE TABLE IF NOT EXISTS class_plans (
      ...
      phase TEXT NOT NULL,
      theme TEXT NOT NULL,
      generalObjective TEXT NOT NULL DEFAULT '',
      specificObjective TEXT NOT NULL DEFAULT '',
      technicalFocus TEXT NOT NULL,
      physicalFocus TEXT NOT NULL,
      pedagogicalRule TEXT NOT NULL DEFAULT '',
      weekNotes TEXT NOT NULL DEFAULT '',
      ...
      derivedFromBlueprintVersion INTEGER NOT NULL DEFAULT 1,
      generationModelVersion TEXT NOT NULL DEFAULT '',
      generationContextSnapshotJson TEXT NOT NULL DEFAULT '',
      syncStatus TEXT NOT NULL DEFAULT 'in_sync',
      outOfSyncReasonsJson TEXT NOT NULL DEFAULT '[]',
      manualOverridesJson TEXT NOT NULL DEFAULT '{}',
      manualOverrideMaskJson TEXT NOT NULL DEFAULT '[]',
      lastAutoGeneratedAt TEXT NOT NULL DEFAULT '',
      lastManualEditedAt TEXT NOT NULL DEFAULT '',
      source TEXT NOT NULL,
      createdAt TEXT NOT NULL,
      updatedAt TEXT NOT NULL
    );

    CREATE TABLE IF NOT EXISTS monthly_planning_blueprints (
      id TEXT PRIMARY KEY NOT NULL,
      classId TEXT NOT NULL,
      cycleId TEXT NOT NULL DEFAULT '',
      ...
      title TEXT NOT NULL DEFAULT '',
      macroIntent TEXT NOT NULL DEFAULT '',
      pedagogicalProgression TEXT NOT NULL DEFAULT '',
      weeklyFocusDistributionJson TEXT NOT NULL DEFAULT '[]',
    ...
    CREATE TABLE IF NOT EXISTS daily_lesson_plans (
      ...
      generationVersion INTEGER NOT NULL DEFAULT 1,
      derivedFromWeeklyVersion INTEGER NOT NULL DEFAULT 1,
      generationModelVersion TEXT NOT NULL DEFAULT '',
      generationContextSnapshotJson TEXT NOT NULL DEFAULT '{}',
      syncStatus TEXT NOT NULL DEFAULT 'in_sync',
      outOfSyncReasonsJson TEXT NOT NULL DEFAULT '[]',
  ...
  try {
    db.execSync("DROP INDEX IF EXISTS class_plans_unique_week");
  } catch {}

  try {
    db.execSync(
      "CREATE UNIQUE INDEX IF NOT EXISTS class_plans_unique_cycle_week ON class_plans (classId, cycleId, weekNumber)"
    );
  } catch {}
  ...
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN generalObjective TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN specificObjective TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN pedagogicalRule TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN weekNotes TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN blueprintId TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN generationVersion INTEGER NOT NULL DEFAULT 1"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN derivedFromBlueprintVersion INTEGER NOT NULL DEFAULT 1"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN generationModelVersion TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN generationContextSnapshotJson TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN syncStatus TEXT NOT NULL DEFAULT 'in_sync'"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN outOfSyncReasonsJson TEXT NOT NULL DEFAULT '[]'"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN manualOverridesJson TEXT NOT NULL DEFAULT '{}'"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN manualOverrideMaskJson TEXT NOT NULL DEFAULT '[]'"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN lastAutoGeneratedAt TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN lastManualEditedAt TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE daily_lesson_plans ADD COLUMN blocksJson TEXT NOT NULL DEFAULT '[]'"
    );
  } catch {}
  try {
    db.execSync(
  ...
  try {
    db.execSync(
      "ALTER TABLE monthly_planning_blueprints ADD COLUMN cycleId TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
      "ALTER TABLE class_plans ADD COLUMN cycleId TEXT NOT NULL DEFAULT ''"
    );
  } catch {}
  try {
    db.execSync(
  ...
  try {
    db.execSync(
      "CREATE INDEX IF NOT EXISTS idx_monthly_blueprints_class_cycle ON monthly_planning_blueprints(classId, cycleId, year, month)"
    );
  } catch {}
  try {
    db.execSync(
