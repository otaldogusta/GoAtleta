export const ptBR = {
  ...
  session: {
    ...
    report: {
      ...
      draftRestored: "Rascunho recuperado neste aparelho.",
      draftSaving: "Salvando rascunho...",
      draftSaved: "Rascunho salvo automaticamente neste aparelho.",
      pse: "PSE (0-10)",
    ...
    success: {
      ...
      reportGenerated: "PDF do relatório baixado com sucesso.",
    ...
    errors: {
      ...
      reportGenerateFailed: "Não foi possível baixar o PDF do relatório.",
