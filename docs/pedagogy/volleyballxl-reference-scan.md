...
| Local | Beach, Home drills, Indoor | Mapear para ambiente: quadra, casa, praia |
| Numero de jogadores | 1 a 12, mais de 12 | Definir organizacao: individual, dupla, trio, equipes reduzidas, turma |
| Situacao de jogo | Rally game, Service game, Sideout game | Conectar ao contexto decisional do bloco principal |
| Fase de treino | Start, Main, Final | Mapear para aquecimento, parte principal e fechamento |
| Tipo | Challenge, Volleystars | Usar como estilo: desafio curto, jogo ludico, tarefa guiada |
| Formato | 1vs1, 2vs2, 3vs3, 4vs4, 5vs5, 6vs6 | Dosar complexidade conforme idade e maturidade |
| Tags | agility, ball handling, trajectory recognition, communication, conditioning, coordination, core stability, defense, endurance, focus, injury prevention, libero, mobility, motor skills, out-of-system, overhead pass, passing, pepper, plyometrics, rally, serve receive, service, sideout, speed, setter, strength, transition, wall, etc. | Usar como familias de exercicio e criterios de busca |
...
| u18 | 13-14 e 15-17 / formation-specialization / MV2-MV3 | moderada a alta | 3x3, 4x4, transicao, sideout, rally |
| seniors | 18+ / aplicado | alta | 4x4, 5x5, 6x6, funcoes por posicao, pressao |

## Criterios de dificuldade

Baixa:
- Poucos jogadores por bola.
- Alvo grande, distancia curta e bola previsivel.
- Sem eliminacao e com reinicio rapido.
- Foco em controle, coordenacao, chamada da bola e continuidade simples.

Moderada:
- Trio ou equipe pequena.
- Alternancia de funcao, leitura de zona e pontuacao bonus.
- Entrada por saque adaptado ou lancamento variado.
- Foco em recepcao jogavel, segundo contato e decisao simples.

Alta:
- Oposicao real em 3x3, 4x4 ou mais.
- Transicao defesa-ataque, out-of-system, cobertura e sideout.
- Pressao de tempo, zona menor ou bola de entrada mais rapida.
- Foco em decisao funcional, comunicacao e continuidade sob erro.

## Amostra observada na sessao logada
